...
if (fs.existsSync(sourceImage)) {
    ...
    console.log("Copper Sheet source image not found:", sourceImage);
}
...
if (sheets) {
    ...
    for (let i = 0; i < origLength; i++) {
        ...
        else if (img.includes('A36 Carbon Steel Plate & Sheet .png')) newImg = renameFile(img, 'Carbon Steel Plate Gr. A36') || img;
        else if (img.includes('CS COIL.webp')) newImg = renameFile(img, 'Carbon Steel Coils') || img;
        else if (img.includes('Mirror Stainless Steel Plate .png')) newImg = renameFile(img, 'Stainless Steel Sheet Gr.430') || img;
        ...
        else if (img.includes('Stainless Steel Hot Rolled Coil .png')) newImg = renameFile(img, 'Stainless Steel HR Coils 304') || img;
        else if (img.includes('Stainless Steel Sheet Gr.304.png')) newImg = renameFile(img, 'Aluminium Plate & Sheet') || img;
